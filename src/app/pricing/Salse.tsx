  ...
  return (
    <div className="container">
      <div className="rounded-lg lg:mb-[140px] mb-10">
        <div className="text-3xl font-bold text-gray-900 text-center mb-4 hidden lg:block">
          Immigrate Without a Hassle
        </div>
        <div className="text-xl font-bold text-gray-900 text-center mb-4 lg:hidden">
          Pricing Table
        </div>
        <div className="lg:text-md text-sm text-neutral-500 max-w-[618px] lg:mb-16 mb-6 m-auto text-center">
