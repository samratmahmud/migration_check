  ...
  return (
    <div>
      <div className="container lg:mb-[140px] mb-10">
        <div className="max-w-[600px] lg:text-3xl text-xl font-bold text-gray-900 mb-4 m-auto text-center">
          Book a session to meet our coaches
        </div>
        <div className="lg:text-md text-sm text-neutral-500 max-w-[600px] m-auto text-center lg:mb-16 mb-5">
